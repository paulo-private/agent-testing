...
@dataclass
class ReportConfig:
    """Configuration for report formatting and content."""
    report_format: str
    title: str
    locale: str
    timezone: str
...
@dataclass
class OutputConfig:
    """Configuration for output and delivery."""
    output_dir: str
...
def generate_report(
    ...
    rows = fetch_data(user_id, start_date, end_date, output_config.max_rows)
